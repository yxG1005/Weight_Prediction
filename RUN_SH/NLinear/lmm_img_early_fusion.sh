...
do
    ...
    do
        ...
        --des 'Exp' \
        --lamda $lamda \
        --checkpoints "/share/ckpt/yxgui/LTSF-CKPT/NLinear/lmm_img_early_fusion" \
        --itr 1 --batch_size 32 --learning_rate 0.005 >./logs/NLinear/lmm_img_early_fusion/$model_name'_'weight_$seq_len'_'$pred_len'_'$features"_"$breakfast$lunch$supper"_l_"$lamda.log
