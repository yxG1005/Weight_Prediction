...
do
    ...
    do
        ...
        python -u run_longExp.py \
            ...
            --itr 1 --batch_size 32 --learning_rate 0.005 >logs/PatchTST/lmm/$model_name'_'weight_$seq_len'_'$pred_len'_'$features'_depth_'$e_layers'_d_model'$d_model'_nhead'$h'd_ff'$d_ff"_l_"$lamda.log
